...
public class FengShi extends Formation {
    public FengShi(Position head, int dir){
        ...
        this.pos.add(5,new Position(head.getX()-1*dir,head.getY()+0));
        this.pos.add(6,new Position(head.getX()-2*dir,head.getY()-0));
        this.pos.add(7,new Position(head.getX()-3*dir,head.getY()+0));
    }
}
