...
public class ChongE extends Formation {
    public ChongE(Position head, int dir){
        ...
        this.pos.add(4,new Position(head.getX()-2*dir,head.getY()-1));
        this.pos.add(5,new Position(head.getX()-2*dir,head.getY()+1));
        this.pos.add(6,new Position(head.getX()-2*dir,head.getY()+3));
        this.pos.add(7,new Position(head.getX()-2*dir,head.getY()+5));
    }
}
